...
#define GoW    		 0	/* Turn on Green Led in West/East way and Red Leds in others */
#define WaitW  		 1	/* Turn on Yellow Led in West/East way and Red Leds in others */
#define GoS    		 2	/* Turn on Green Led in South/North way and Red Leds in others */
#define WaitS  		 3	/* Turn on Yellow Led in South/North way and Red Leds in others */
...
SType FSM[10]=
{
 {0x21, RED, 100, {GoW, WaitW, WaitW, WaitW, WaitW, WaitW, WaitW, WaitW}},
 {0x22, RED, 100, {GoS, GoS, GoS, GoS, Walk, Walk, GoS, GoS}},
 {0x0C, RED, 100, {GoS, WaitS, WaitS, WaitS, WaitS, WaitS, WaitS, WaitS}},
 {0x14, RED, 100, {Walk, GoW, GoW, GoW, Walk, Walk, Walk, Walk}},
 {0x24, GREEN, 100, {Walk, HurryUP1, HurryUP1, HurryUP1, Walk, HurryUP1, HurryUP1, HurryUP1}},
 ...
 {0x24, RED, 100, {GoW, GoS, GoW, GoW, Walk, GoW, GoS, GoW}}
};
